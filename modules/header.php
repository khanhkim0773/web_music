<header id='header'>
            <div class="sub-header">
                ...
                <section class="search-box">
                    <form action="search_page.html" id="" method="get">
                        <input type="text" class="search-text" placeholder="Tìm kiếm bài hát">
                        <button class="search-btn" onclick="window.location.href = 'search_page.html'" ><i class="fa-solid fa-magnifying-glass"></i></button>
                    </form>
                </section>
            </div>
