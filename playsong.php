                ...
                <div class="bottom-left">
                    ...
                    <div class="thongtin">
                        ...
                        <div class="noidungmota">
                            <div class="noidungmotabaihat">Nội dung mô tả</div>
                            <div class="xemthem">
                                <div class="player-controls__item" @click=""> <!-- bổ sung -->
                                    <svg class="icon">
                        ...
                        <div class="comment">
                            <div class="input-group-text">
                                <div class="player-controls__item -heroicon -avt" @click=""> <!-- bổ sung -->
                                    <svg>
                                        <use xlink:href="#icon-avt"></use>
                                    </svg>
                                </div>
                                <input type="text" placeholder="Comment..."/>
                                <span class="item-comment">
                                    <div class="player-controls__item -heroicon -avt">
                                        <svg class="icon-avt">
                                ...
                                <div class="player-controls__item -heroicon -avt">
                                    <svg class="icon-avt">
                                        <use xlink:href="#icon-send-comment"></use>
                                    </svg>
                                </div>
                            </div>
                            </br><hr>
